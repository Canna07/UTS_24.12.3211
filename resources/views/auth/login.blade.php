    ...
    <form action="{{ route('admin.login.post') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input
                ...
                name="email"
                value="{{ old('email') }}"
                class="w-full border-2 border-slate-200 rounded-2xl px-5 py-4 focus:border-indigo-600 outline-none"
                required>
        ...
        <button
            type="submit"
            class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700">
